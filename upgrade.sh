...
scp "$PWD/build/PowSpy.bin" root@debian.fritz.box:/tmp/esp32
...
docker run --init -it --rm efrecon/mqtt-client sh -c "pub -h debian.fritz.box -t 'devices/cc50e395f224/\$update' -m true ; sub -h debian.fritz.box -t 'devices/cc50e395f224/\$state' -C 3 -R -v"
